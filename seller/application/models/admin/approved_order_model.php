<?php
class Approved_Order_model extends CI_Model {
	...
	public function GetRecords($start=0, $limit=10) {
		...
		b.quantity,b.date_modified,b.order_id,b.order_status,d.name,d.email,d.address,d.mobile,e.mailto_buyer_status');
		$this->db->from("tbl_product as a");
		$this->db->join('tbl_product_order as b', 'b.product_id = a.id', 'left');		
		$this->db->join('tbl_user as d', 'd.id = b.buyer_id', 'left');
		$this->db->join('tbl_order as e', 'e.order_id = b.order_id', 'left');
	...
	/*public function GetRecordsByOrderId($order_id) {
		...
		$this->db->select('a.id as product_id,e.seller_id,a.name as product_name,a.code,e.price,a.unit,b.id as cart_id, b.quantity,b.date_modified,b.date_created,b.order_id,b.order_status,c.seller_code,c.business_name as seller_business_name,c.email_id as seller_email,d.name,d.email,d.address,d.mobile');
		$this->db->from("tbl_product as a");		
	...
	public function GetRecordsByOrderId24112020($order_id) {
		$seller_id = $this->session->userdata('seller_id');
