<?php
class Slider_Brand_Image_model extends CI_Model {
    
	private $path = 'public/uploads/slider_brand_image/';
	...
	public function save_slider_brand_image_data($image=null) {
		...
		if($id)			
		{
			...
			$this->db->where('id', $id);
			$this->db->update('tbl_slider_brand_image', $data); 
		}
		else
		{
			$data['date_created']=date('Y-m-d H:i:s');
			$this->db->insert('tbl_slider_brand_image',$data); 			
