...
class Contact_Us extends MY_Controller {
	...
	public function page($page_no)
	{
		...
		$per_page=50;
		$total_record	= $this->contact_us_model->GetTotalRecord();		
		$config['base_url'] = site_url().'admin/contact_us/index';
		...
		$array_records = $this->contact_us_model->GetRecords($offset,$per_page);		
