...
class Product extends MY_Controller {
	...
	{
		$data['heading']='Your Product List'; 
		...
		$brand = $this->product_model->GetSellerBrand();
		$data['brand'] = $brand;
	...
	{	
		...
		if($id){
			$array_records = $this->product_model->GetRecordById($id);
		}else{
			$array_records=array();
		}
	...
	{
		$save = $this->product_model->save_product_data1();				
		if($save){
	...
	public function update_price(){		
		...
		session_start();
		//$data1['update_product_msg'] = "product which contains packet the price will not updated.";
