...
$route['mailsent'] = "index";
$route['inactive-seller'] = "index";
$route['invalid-seller'] = "index";
$route['sucess/(:any)'] = "index/sucess/$1";
$route['forgot_password'] = "index/forgot_password";
$route['activate_account/([0-9]+)'] = "index/activate_account/$1";
$route['send_email_verification_link/(:any)'] = "index/send_email_verification_link/$1";
...
$route['cityDropdown/(:any)'] = "index/cityDropdown/$1";
$route['pincodeDropdown/(:any)'] = "index/pincodeDropdown/$1";
