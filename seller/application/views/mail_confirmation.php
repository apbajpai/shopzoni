        ...
        <div class="col-md-6">
          <div class="panel-body">		              
			<div class="account lpmrgn">
				...
				<p>Your account has been created. To move on to the next step, log in to your mail account and click on the verification link sent to your e-mail.<br>
				( <?php echo $seller_record->email_id; ?> )</p>
				<p>Haven't received the mail yet? <a href="<?php echo base_url(); ?>send_email_verification_link/<?php echo base64_encode($seller_record->id); ?>" >Click</a> here to Resend.</p>
				<p></p>
			</div>
          </div>
        </div>
