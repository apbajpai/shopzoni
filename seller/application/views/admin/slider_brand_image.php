...
<div class="centercontent tables">
	...
	<?php //Search start ?>
		...
		<input type="hidden" name="controller" id="controller" value="slider_brand_image" />
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<tbody>
				...
				$image_path = base_url()."public/uploads/slider_brand_image/".$data->image;
				?>
					<tr class='gradeA'>
						...
						<td>
							<a href="<?php echo base_url() ?>admin/slider_brand_image/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a> <br>							
