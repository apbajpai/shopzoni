...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="product" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url()?>admin/brand_product/save">	
				...
				<p>
					...
					<span class="field">
						<select name="associated_brand_id" id="associated_brand_id" disabled="disabled">
							<option value="">Select Brand</option>
							<?php
								foreach($associatedbrands as $assval){
									if($selected_brand_id==$assval->id)$selected='selected="selected"';
									else $selected='';
							?>
				...
				<p>
					<label>Product Image</label>
						<span class="field">
						<input type="file" name="image" id="image">(jpg | png | jpeg | gif ) [width 750 X height 350]
				...
				<p>
				<span><b>Product Added Through " "  Shop, Other Fields Are Closed For Editing.</b></span>
				</p>
				...
				<p>
					...
					<span class="field">
						...
						<br>
						Check Here For Minimum Quantity Alert
					</span>					
				</p>
				...
				<p>
					<label>Offer</label>
					<span class="field">						
						<input name="offer" id="offer" class="longinput"  maxlength="20" value="<?php echo $offer?>" />
					</span>	
					<span class="field" style="font-weight:bold">Not More than 20 Character.</span>
				</p>
				...
				<p class="stdformbutton">				
					...
					<input type="hidden" name="sell_yours" id="sell_yours" value="<?php echo $sell_yours?>">
					
					<span class="field"><strong>[ Please Update your quantity,price and offer after approval of the product by Admin. ]</strong></span>
				</p>
