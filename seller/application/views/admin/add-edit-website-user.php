<?php define('AJAXPATH',site_url().'application/views/admin/ajax/'); ?>
...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="website_user" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url();?>admin/website_user/save">	
	...
	jQuery("#website_user").validate({		
		rules: {
			...
			email_id: {
                ...
                email: true,
				remote: {
					url: "/admin/website_user/uniqueUser",
					type: "post",
					data: {
						email_id: function() {
