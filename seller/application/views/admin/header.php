...
<title>Seller Admin :: <?php echo isset($heading)?$heading:"Dashboard"; ?></title>
...
<div class="bodywrapper">
    <div class="topheader">
        <div class="left">
            <h1 class="logo">Shopzoni<span></span></h1>
            <span class="slogan">Admin Panel</span>    
			<h4 class = "active" style="color:#fff; padding-top:7px;"> For Help Call : 9899616204 </h4>
            <br clear="all" />            
        </div><!--left-->        
        <div class="right">
            <div class="userinfo">
            	<img src="<?php echo VIEWBASE; ?>images/thumbs/avatar.png" alt="" />
                <!--<span><?php echo $this->session->userdata('name'); ?>[<?php echo $this->session->userdata('seller_code'); ?>]</span>-->
                <span>vendor name-</span><span><?php echo $this->session->userdata('name'); ?></span>
				<span>vendor code-</span><span><?php echo $this->session->userdata('seller_code'); ?></span>
				<span>[<?php if($this->session->userdata('type') == '0'){ ?>WholeSeller<?php }else if($this->session->userdata('type') == '1'){ ?>Retailer<?php } ?>]</span>
            </div><!--userinfo-->            
