		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<tbody>
				<?php $i=0; foreach($records as $data){$i++; ?>
					<tr class='gradeA' <?php if($data->read_unread_status==0){ ?> style="background-color:#FFFFD4" <?php } ?>>						
						<td><?php echo $data->id; ?></td>
						<td><?php echo $data->seller_code; ?></td>
						...
						<td><a href="<?php echo base_url() ?>admin/message_seller/view/<?php echo $data->id; ?>"><input type="submit" value="View"> <br></td>
					</tr>
				<?php }?>	
