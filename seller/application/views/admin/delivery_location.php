...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">
				...
				<tbody>
					<tr>						
						...
						<td style="width:18%; vertical-align:top; border-top: 1px solid #ddd;">
							&nbsp;
							<input type="text" name="delivery_location" id="delivery_location" value="<?php echo $search['delivery_location']; ?>">
						</td>
		...
		<input type="hidden" name="controller" id="controller" value="delivery_location" />
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				<tr>
					...
					<th class="head1">Shipping Charge</th>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
							<a href="<?php echo base_url();?>admin/delivery_location/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
