		...
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="seller" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url()?>admin/seller_registration/save">	
				...
				<p>
					...
					<span class="field">
						<input type="text" readonly='readonly' name="business_name" id="business_name" class="longinput" value="<?php echo $business_name?>" />
					</span>					
				</p>
...
jQuery('#state_id').change(function(){
		...
		url = "<?php echo base_url(); ?>admin/seller_registration/cityDropdown/"+state_id;		
