		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				...
				<tr>									
					...
					Phone : <?php echo $records[0]->buyer_mobile; ?>&nbsp;&nbsp;&nbsp;
					Email : <?php echo $records[0]->buyer_email; ?></th>
				</tr>				
				<?php } ?>	
			...
			<tbody>
				...
				?>
					<tr class='gradeA'>
						...
						<td>
							<div id="orderstatusDiv<?php echo $data->product_id; ?>">
								<?php if($data->order_status==3){ ?>
								<input onclick="approveOrderStatus('<?php echo $data->product_id; ?>','<?php echo $data->order_id; ?>')" type="submit" name="order_status" id="order_status" value="Approve">
								<?php }else{ echo $order_status; } ?>
							</div>
...
<script>
	...
	function approveOrderStatus(product_id,order_id) {
		jQuery.ajax({
			type: "POST",
