...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="product" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url()?>admin/slider_brand_image/save">	
				...
				<p>
					<label>Image</label>
						...
						<?php if($image){
							$image_path = base_url()."public/uploads/slider_brand_image/".$image;						
