			...
			<tbody>
				...
				?>
					<tr class='gradeA'>
						...
						<td>
							<div id="orderstatusDiv<?php echo $data->cart_id; ?>">
								<?php if($data->order_status==3){ ?>
								<input onclick="approveOrderStatus('<?php echo $data->cart_id; ?>')" type="submit" name="order_status" id="order_status" value="Approve">
