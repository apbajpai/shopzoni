...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">            	
			<form enctype="multipart/form-data" method="post" class="stdform" id="product" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url()?>admin/quantity_alert/save">	
				...
				<p>
					<label>Offer</label>
					<span class="field">						
						<textarea name="offer" id="offer" rows="5" cols="60" ><?php echo $offer?></textarea>
					</span>	
				</p>
