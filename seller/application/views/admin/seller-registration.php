			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
				<tbody>
					...
					<tr>
						...
						<td style="width:18%; vertical-align:top; border-top: 1px solid #ddd;">
							&nbsp;
							<input type="text" name="seller_code" id="seller_code" value="<?php echo $search['seller_code']; ?>">
						</td>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				<tr>
					...
					<th class="head1" style='width: 35%;'>Seller Name[Code]</th>
					<th class="head0" style='width: 10%;'>Type</th>
			...
			<tbody>
				...
				?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->name; ?>[<?php echo $data->seller_code;?>]</td>
						<td><?php echo $type; ?></td>
						...
						<td><?php if($data->date_created >0){ echo GetDateFormat($data->date_created); } ?></td>
