...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
				...
				<?php if($this->session->userdata('type')==1){ ?>
					<tr>						
						...
						<td colspan="2" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">&nbsp;</td>						
					</tr>
				<?php } ?>	
		...
		<input type="hidden" name="controller" id="controller" value="cancel_order" />
			...
			<tbody>
				...
				$i=0;foreach($records as $data){$i++; ?>
					<tr class='gradeA'>
						...
						<td><a href="<?php echo base_url() ?>admin/cancel_order/view/<?php echo $data->order_id; ?>"><input type="submit" value="View"> <br></td>
						<!--<td>
							<div id="orderstatusDiv<?php echo $data->order_id; ?>">
								<?php if($data->mailto_buyer_status=='' || $data->mailto_buyer_status==0){ ?>
								<input onclick="sendMailToBuyer('<?php echo $data->order_id; ?>')" type="submit" name="send_mail" id="send_mail" value="Send Mail">
