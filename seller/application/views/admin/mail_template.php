...
$content="Please login your account with below mentioned details and check your credentials.";
	...
	<body style="background:#eee; margin-bottom:0px; margin-left:0px; margin-right:0px; margin-top:0px;"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  ...
	  <tr>
		<td align="left" valign="top"><table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td align="left" valign="top" width="30%">Details</td>
	  ...
	  <tr>
		<td align="center" valign="middle" bgcolor="0068b7" height="30" style="color:#fff; font-size:15px;">© 2017 by Shopzoni</td>
	</td>
	  </tr>
	</table>
	</body>
	...
	$to=$email_id;
	$subject="Your Updated Credentials. " ;
	$from="info@shopzoni.com";
	$bcc_email="admin@shopzoni.com";
