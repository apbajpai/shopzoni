			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
				<tbody>
					...
					<tr>					
						...
						<td style="width:18%; vertical-align:top; border-top: 1px solid #ddd;">
							&nbsp;
							<input type="text" name="email" id="email" value="<?php echo $search['email']; ?>" placeholder="Email">
						</td>
						
						
						<td rowspan="2" colspan="3" style="width:15%; vertical-align:middle; border-top: 1px solid #ddd;">
