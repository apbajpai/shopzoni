...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">
		...
		<input type="hidden" name="controller" id="controller" value="service_center" />
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td>
						<a href="<?php echo base_url();?>admin/service_center/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
