	...
	<div id="contentwrapper" class="contentwrapper">
		...
		<form action="" method="POST" id="searchfm" name="searchfm">
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
				<tbody>
					<tr>						
						<td style="width:14%; vertical-align:top; border-top: 1px solid #ddd;">Brand Name:</td>
		...
		<input type="hidden" name="controller" id="controller" value="brand" />
			...
			<tbody>
				...
				?>
					<tr class='gradeA'>
						...
						<td>
						<a href="<?php echo base_url();?>admin/brand/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
