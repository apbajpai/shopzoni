			...
			<form enctype="multipart/form-data" method="post" class="stdform" id="category" name="add_data_view" accept-charset="utf-8" action="<?php echo base_url()?>admin/category/save">	
				...
				<p>
					...
					<span class="field">
						...
						<label class="error" for="section_id"><p><font color="red"><?php echo $this->session->userdata('section_id'); ?></font></p></label>
					</span>					
				</p>
				...
				<p>
					<span class="field">
						<label class="error" for="section_id"><p><font color="red"><?php echo $this->session->userdata('category_id'); ?></font></p></label>
					</span>
				</p>
