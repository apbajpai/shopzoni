...
class Service_Center_model extends CI_Model {
	...
	private $path = 'public/uploads/service_center/';
	...
	public function GetRecordsControl() {
		...
		$query = $this->db->get("tbl_service_center");
	...
	public function GetRecordByName($contact_person) {
	...
	public function save_service_center_data($image=null) {
		...
		if($id)			
		{
			...
			$this->db->where('id', $id);
			$this->db->update('tbl_service_center', $data); 
		}
		else
		{
			$data['date_created']=date('Y-m-d H:i:s');
			$this->db->insert('tbl_service_center',$data); 
