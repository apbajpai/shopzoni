<?php
class Product_Packet_model extends CI_Model {
    
	private $path = 'public/uploads/product_packet/';
	...
	public function save_product_packet_data() {
		...
		if($id)			
		{
			...
			$this->db->where('id', $id);
			$this->db->update('tbl_packet', $data); 
		}
		else
		{
			$data['date_created']=date('Y-m-d H:i:s');
			$this->db->insert('tbl_packet',$data); 			
