...
$(document).ready(function() {
  ...
  //$('.jqzoom').jqzoom();
    ...
    <div class="container-fluid banner_top_margin mobile_header_top_margin product_page_top_margin" >
    ...
    <div class="container-fluid grid_margin" id="show_seller" style="margin-bottom:-150px;">
      <div class="col-md-12 grid_margin ">
            <div class="panel-body">
              <div class="table-responsive mob__saller_box_hide">
				  ...
				  ?>
				   <tr>
                    <th class="text-center"><?php echo $seller->business_name; ?></th>
					  ...
					  <th class="text-center"><?php echo $seller->offer; ?></th>
					  ...
					  ?>
						<form name ="addtocartfrm" id="addtocartfrm" method="post" action="<?php echo base_url(); ?>login">
                      	<!--<div><button class="btn brand_search_btn btn_list" onclick="buy('<?php echo $seller->product_map_id; ?>','<?php echo $seller->id; ?>'),updateCartCounter('<?php echo $seller->id; ?>');" type="submit">Add To Cart</button></div>-->
                      	<div><button class="btn brand_search_btn btn_list" onclick="check_quantity('<?php echo $seller->product_map_id; ?>','<?php echo $seller->id; ?>');" type="submit">Add To Cart</button></div>
