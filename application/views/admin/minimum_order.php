...
<div class="centercontent tables">
	...
	<div id="contentwrapper" class="contentwrapper">	
		...
		<input type="hidden" name="controller" id="controller" value="minimum_order" />
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			...
			<thead>
				<tr>
					...
					<th class="head1">Minimum Order Amount</th>
			...
			<tbody>
				<?php $i=0;foreach($records as $data){$i++;?>
					<tr class='gradeA'>
						...
						<td><?php echo $data->minimum_order_amount; ?></td>
						...
						<td>
							<a href="<?php echo base_url();?>admin/minimum_order/addedit/<?php echo $data->id; ?>"><strong>Edit</strong></a>
