...
.option_sym{
  ...
  <div class="container-fluid banner_top_margin mobile_header_top_margin" style="padding-top: 25px">
    ...
    <div class="container-fluid padding_l_r shop_filter_prod">
      ...
      <div class="col-md-10 grid_margin">
        <div class="panel-body mob__saller_box_hide">
              <table class="table table-bordered table-striped table-condensed mb-none">
                <thead>
                  <tr>
                    <th class="text-center">&nbsp;</th>
                    <th class="hidden-sm text-center">Name</th>
                    <th class="text-center">Brand</th>					
                    <th class="text-center">Price</th>					
                    <!--<th class="text-center">Qut</th>
		...
		?>
				<?php if($packet[0]->id!=''){ ?>
                  <tr>
                    <td class="text-center"><a href="#" data-toggle="modal" data-target="#myModal<?php echo $product->product_map_id;?>"><img src="<?php echo $image_path; ?>" class="shop_pro_img"></a></td>
                    <td class="text-center shop_cunt">
					<a href="#" title="<?php echo strip_tags($product->short_description); ?>" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom" class="shop_cunt">
					<?php echo $product->name; ?>
					</a>					
					<br>
					<?php if($product->offer){ ?>
					<a  title="<?php echo strip_tags($product->offer); ?>" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom" class="shop_cunt">
					<span style="color:#E57911;font-weight:bold; font-size:18px; text-decoration:underline;"><?php echo "Offer"; ?></span>
					</a>
					<?php } ?>
					</td>
                    <td class="text-center shop_cunt"><?php echo $product->brand_name; ?></td>
                    <!--<td class="text-center shop_cunt"><?php echo $product->price; ?></td>-->
                    <td class="text-center shop_cunt">
                    ...
                    <!--<td class="text-center shop_cunt"><?php echo $product->unit; ?></td>-->
                    ...
                    <td class="text-center"><a class="btn brand_search_btn shop_cunt_bun" buy_now<?php echo $product->product_map_id; ?> onclick="buy_packet('<?php echo $product->product_map_id; ?>'),updateCartCounter();" type="submit">Add to Cart</a></td>
                  </tr>
				<?php }else{ ?>
				  ...
				  <tr>
                    ...
                    <td class="text-center shop_cunt"><?php echo $product->brand_name; ?></td>
                    <!--<td class="text-center shop_cunt"><?php echo $product->price; ?></td>-->
                    <td class="text-left shop_cunt" style="padding-left:14px"> <?php echo $product->weight; ?> <?php echo $product->unit; ?> - Rs. <?php echo $product->price; ?></td>
                    <!--<td class="text-center shop_cunt"><?php echo $product->unit; ?></td>-->
                    <td class="text-center " style="width: 140px">
                        <div class="input-group shop_cunt_input">
                        <span class="input-group-btn"><button class="btn btn-default value-control" data-action="minus" data-target="quantity<?php echo $product->product_map_id; ?>"><span class="glyphicon glyphicon-minus"></span></button></span>
                    ...
                    <td class="text-center"><a class="btn brand_search_btn shop_cunt_bun" buy_now<?php echo $product->product_map_id; ?> onclick="buy('<?php echo $product->product_map_id; ?>'),updateCartCounter();" type="submit">Add to Cart</a></td>
                  </tr>
				<?php } ?>
  ...
  <div class="pro_shop_scroll box_scroll text-center product_saller_detail">
    <!--<div class="">
      <div><img src="<?php echo $image_path; ?>" class="shop_pro_img"></div>
        <div>8 No Offer</div>
        <div>Brand Name</div>
        <div>1 Piece - Rs. 370.00</div>
        <div class="input-group shop_cunt_input">
          <span class="input-group-btn"><button class="btn btn-default value-control" data-action="minus" data-target="quantity1669"><span class="glyphicon glyphicon-minus"></span></button></span>
          <input name="quantity[]" id="quantity1669" value="1" class="form-control qut_text" type="text">
          <div id="productavlDiv1669" style="color:red; font-size:12px;"></div>
          <div id="productavlDivsucess1669" style="color:green; font-size:12px;"></div>
          <span class="input-group-btn"><button class="btn btn-default value-control" data-action="plus" data-target="quantity1669"><span class="glyphicon glyphicon-plus"></span></button></span>
        </div>
        <div><a class="btn brand_search_btn shop_cunt_bun" buy_now1669="" onclick="buy('1669'),updateCartCounter();" type="submit">Add to Cart</a></div>
    </div>-->
